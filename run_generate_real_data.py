...
print("\n=== 1. 上传Python脚本 ===")
sftp = ssh.open_sftp()
sftp.put('d:/code/trae-ai/generate_real_anime_data.py', '/root/generate_real_anime_data.py')
sftp.close()
print("Python脚本已上传")

# 2. 运行脚本
print("\n=== 2. 运行脚本 ===")
print("开始生成真实动漫数据，请稍候...")

stdin, stdout, stderr = ssh.exec_command("python3 /root/generate_real_anime_data.py 2>&1")
out = stdout.read().decode('utf-8', errors='ignore')
err = stderr.read().decode('utf-8', errors='ignore')
print(out)
if err:
